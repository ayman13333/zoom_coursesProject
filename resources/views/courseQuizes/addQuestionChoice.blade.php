...
<div class="container">
    ...
    <form method="POST" action="{{route('CourseQuizAddChoice')}}" enctype="multipart/form-data">
        @csrf
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="choice_name" style="margin-top: 10px" placeholder="قم ب ادخال كل اخيار مع كل ضغطة زر" >
        </div>
        <div class="form-group">
